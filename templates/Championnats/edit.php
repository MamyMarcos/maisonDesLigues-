<div class="container-md">
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title"><?= $this->Icon->faIcon('fas fa-edit') ?> Modifier le championnat n&deg;<?= $leChampionnat->id?></h3>
        </div>
        <?= $this->Form->create($leChampionnat) ?>
        <div class="card-body">
        ...
        <div class="card-footer">
            <?= $this->Form->button(__("Modifier le championnat"), ['class' => 'btn btn-primary']); ?>
